        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <img alt="" height="100" width="100" src="https://uploads.turbologo.com/uploads/design/preview_image/4551835/preview_image20211224-8647-1g7dld3.png" />
                </svg>
            </div>
                ...
                @if (isset($posts))
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        @foreach ($posts as $post)
                            <a href="{!! Route::current()->getName() !!}/blog/{!! $post->id !!}"
                                class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    <div
                                        class="h-auto w-full bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-pill">
                                        @if ($post->image != null)
                                            <img height="200" width="400" class="rounded-pill"
                                                src="{!! $post->image !!}" alt="">
                                        @else
                                            {!! $post->id !!}
                                        @endif
                ...
                @elseif (isset($users))
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        @foreach ($users as $user)
                            <a href="{!! Route::current()->getName() !!}/user/{!! $user->id !!}"
                                class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    <div
                ...
                @elseif (isset($user))
                    <div class="">
                        ...
                        @if ($user->posts->count() > 0)
                            <div class="mt-12 scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none">
                                All Posts : {!! $user->posts->count() !!}
                                @foreach ($user->posts as $post)
                                    <a href="{!! Route::current()->getName() !!}/blog/{!! $post->id !!}"
                                        class="my-4 scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                        <div>
                                            <div
                                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                                {!! $post->id !!}
